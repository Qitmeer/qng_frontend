...
const Link = chakra((props: LinkProps) => {
  const defaultHref = route({ pathname: '/qitmeer_tx/[hash]', query: { hash: props.hash } });
...
const UTXOTxEntity = (props: EntityProps) => {
...
export default React.memo(chakra<As, EntityProps>(UTXOTxEntity));
